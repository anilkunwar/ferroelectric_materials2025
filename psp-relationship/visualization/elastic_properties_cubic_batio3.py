...
if 'matrix_input' not in st.session_state:
    st.session_state.matrix_input = """286      108      108       0       0        0  
       108      286      108        0       0       0  
       108      108      286       0        0       0  
        0        0       0      120        0        0  
        0       0        0        0      120        0  
...
if 'material_name' not in st.session_state:
    st.session_state.material_name = "BaTiO3 (Cubic)"
...
\end{pmatrix}
""")
st.subheader("The following visualization is applicable to all crystal symmetries for 3D materials,including cubic, tetragonal, orthorhombic, and lower symmetries like monoclinic and triclinic, when provided with a valid 6x6 stiffness matrix in Voigt notation.")
